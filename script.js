document.addEventListener('DOMContentLoaded', () => {
    ...
    const texts = [
        ...
        "How are you today?",
      "Jonas can be serious if needed",
        "This is how we dance",
        "You are taking things way too seriously",
        "Are you scared of robots?",
      "Jonas made this website in HTML",
      "Jonas client list includes Volvo, Absolut Vodka, H&M, Uniqlo, Audi and many more",
      "Jonas have made music for lots of adverts",
              "Jonas worked with No Doubt",
              "Jonas made 3D art for Per Gessles elevator",
        "Did you know that Jonas made the first swedish NFT",
        "I'm just a shy boy",
        "All because of you",
        "I've been to the ocean",
      "Jonas Quant has written music with Kylie Minogue",
        ...
        "Be nice to the nice",
        "Grow up",
      "Jonas Quant has written music with Leona Lewis",
        ...
        "Human race",
        "Take chances",
        "Jonas Quant produced Hurts album Happiness that sold many many copies",
